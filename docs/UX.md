...
> **NEXT FREE SECTION NUMBER: §7.40.** (ROADMAP C4.) This document assigns
> §7 numbers, so it is the one place that can say what is taken. §7.24 was
> written **twice in the same week** by two branches and only caught at the
> merge. Claim your number by bumping this line in your first commit, before
> you write the section — a branch that has been out for a week cannot see
> what another one took, and this line is the only thing that can tell it.
...
### 7.39 The token layer — the kind of choice picks the dress (2026-08-14)
