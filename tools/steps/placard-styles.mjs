...
export default async function run(stage, [outDir = 'tools/shots/placard-styles', w = '1600', h = '900', nArg = '4']) {
  ...
  const DRESSES = [
    ...
    ['emboss ', { 'cards.style': 'embossed', 'cards.ink.tone': 'ink', 'cards.scale': 1 }, 'embossed-gold'],
    ['embossS', { 'cards.style': 'embossed', 'cards.ink.tone': 'chalk', 'cards.scale': 1 }, 'embossed-silver'],
    ['emboss+', { 'cards.style': 'embossed', 'cards.ink.tone': 'ink', 'cards.scale': 1.5 }, 'embossed-big'],
